...
export default class AudioSystem {
    ...
    static asyncLoadSounds() {
        ...
        return Promise.all(Object.keys(resources.sounds).map(name => {
            ...
            const url = `https://cdn.jsdelivr.net/gh/nbjrkzddz/zxcvbnm@42109a8e1cd488444f66869807cfb27b8e14f43f/games/burgerandfrights/sounds/${info.path}${config.debug.preventCaching ? '?time=' + new Date().getTime() : ''}`;
