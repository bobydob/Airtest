...
if(isAdinPlayEnabled())
{
    if(displayAdProvider === AdProviderAdinplay)
    {
        ...
        adinplayDisplayScript.src = "https://cdn.jsdelivr.net/gh/bobydob/Airtest@master/11/ads-adinplay-display.js";
    ...
    if(videoAdProvider === AdProviderAdinplay)
    {
        ...
        adinplayVideoScript.src = "https://cdn.jsdelivr.net/gh/bobydob/Airtest@master/11/ads-adinplay-video.js";
